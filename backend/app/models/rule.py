...
class Rule(Base):
    ...
    symbol: Mapped[str] = mapped_column(String(16), index=True, nullable=False)  # örn: THYAO
    ...
    # İndikatöre özel dinamik parametreler (örn: period: 14)[cite: 2]
    parameters: Mapped[dict[str, Any]] = mapped_column(JSONB, nullable=False, default=dict)
    
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    
    # State Transition (Spam Önleme) için son kural durumu[cite: 2]
